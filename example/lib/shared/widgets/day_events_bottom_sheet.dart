      ...
      return DraggableScrollableSheet(
        ...
        builder: (context, scrollController) {
          ...
          return CustomScrollView(
            ...
            slivers: [
              // Pinned handle bar + header — stays at top while
              // the event list scrolls underneath.
              PinnedHeaderSliver(
                child: ColoredBox(
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              l10n.bottomSheetEventCount(events.length),
              ...
              // Hint text (scrolls with the list)
