...
import '../../../shared/utils/event_colors.dart';
...
/// - Custom cell backgrounds with rounded corners
/// - Dots-based event visualization (instead of event tiles)
/// - Custom navigator with modern button styling
/// - Selection state visualization
class MonthModernStyle extends StatelessWidget {
  const MonthModernStyle({
    super.key,
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: ctx.isToday
                  ...
                  : colorScheme.onSurface.withValues(alpha: 0.39),
            ),
          ),
        ],
      ),
