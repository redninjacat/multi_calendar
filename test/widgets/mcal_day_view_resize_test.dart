  ...
  group('MCalDayView resize gestures', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final theme = MCalThemeData(dayViewTheme: MCalDayViewThemeData(minResizeDurationMinutes: 60));
    ...
    testWidgets('events at or above min duration show resize handles', (
      ...
      final theme = MCalThemeData(dayViewTheme: MCalDayViewThemeData(minResizeDurationMinutes: 30));
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final theme = MCalThemeData(dayViewTheme: MCalDayViewThemeData(minResizeDurationMinutes: 15));
